...
# Model 2:                                   #
# Meta : MLP                                 #
# Base : DT, KNN, LR, aDaboost, linearSVM    #
##############################################
...
# Initializing models
clf0 = DecisionTreeClassifier(random_state=1)
...
params = {
        ...
        #   'meta_classifier__hidden_layer_sizes': [(100,), (50,50), (100,50,50)],
          # 'mlpclassifier__hidden_layer_sizes': [(100,), (50,50), (100,50,50)],
            # 'meta_classifier__activation': ['relu', 'tanh', 'logistic'],
            # 'meta_classifier__solver': ['sgd', 'adam'],
            # 'meta_classifier__alpha': [0.0001, 0.05],
            # 'meta_classifier__learning_rate': ['constant','adaptive'],
            # 'meta_classifier__max_iter': [200, 500],
            # 'meta_classifier__batch_size': [100, 200],
          'adaboostclassifier__n_estimators': [150],
        #   'linearsvc__C': [0.1, 10.0],
...
import pickle
model_dir = 'models'
with open(model_dir+'/stacking_model2_base_whole_best.pkl', 'wb') as f:
    pickle.dump(grid, f)
